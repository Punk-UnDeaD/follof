 ...
 */
final class Version20200414142806 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_user_sip_accounts (id UUID NOT NULL, user_id UUID NOT NULL, login VARCHAR(32) NOT NULL, password VARCHAR(32) NOT NULL, status VARCHAR(16) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_8F03B005A76ED395 ON user_user_sip_accounts (user_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8F03B005AA08CB10 ON user_user_sip_accounts (login)');
        $this->addSql('COMMENT ON COLUMN user_user_sip_accounts.user_id IS \'(DC2Type:user_user_id)\'');
        ...
        $this->addSql('ALTER TABLE user_user_sip_accounts ADD CONSTRAINT FK_8F03B005A76ED395 FOREIGN KEY (user_id) REFERENCES user_users (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE user_user_sip_accounts');
