 ...
 */
final class Version20200506194435 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE billing_voice_menus (id UUID NOT NULL, team_id UUID DEFAULT NULL, data JSON NOT NULL, file VARCHAR(255) NOT NULL, status VARCHAR(16) NOT NULL, internal_number_number VARCHAR(16) NOT NULL, PRIMARY KEY(id))');
