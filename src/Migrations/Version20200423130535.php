...
final class Version20200423130535 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'CREATE TABLE billing_team (id UUID NOT NULL, owner_id UUID DEFAULT NULL, user_id UUID NOT NULL, billing_id VARCHAR(255) NOT NULL, ballance_value NUMERIC(8, 2) NOT NULL, PRIMARY KEY(id))'
        );
        ...
        $this->addSql(
            'CREATE TABLE billing_sip_accounts (id UUID NOT NULL, member_id UUID DEFAULT NULL, login VARCHAR(32) NOT NULL, password VARCHAR(128) NOT NULL, status VARCHAR(32) NOT NULL, PRIMARY KEY(id))'
        );
        ...
        $this->addSql(
            'CREATE TABLE billing_members (id UUID NOT NULL, team_id UUID DEFAULT NULL, login VARCHAR(25) DEFAULT NULL, email VARCHAR(128) DEFAULT NULL, password_hash VARCHAR(255) DEFAULT NULL, role VARCHAR(32) NOT NULL, status VARCHAR(16) NOT NULL, PRIMARY KEY(id))'
        );
        ...
        $this->addSql(
            'ALTER TABLE billing_team ADD CONSTRAINT FK_BB9298D87E3C61F9 FOREIGN KEY (owner_id) REFERENCES billing_members (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE'
        );
        $this->addSql(
            'ALTER TABLE billing_team ADD CONSTRAINT FK_BB9298D8A76ED395 FOREIGN KEY (user_id) REFERENCES user_users (id) NOT DEFERRABLE INITIALLY IMMEDIATE'
        );
        $this->addSql(
            'ALTER TABLE billing_sip_accounts ADD CONSTRAINT FK_42873CD97597D3FE FOREIGN KEY (member_id) REFERENCES billing_members (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE'
        );
        $this->addSql(
            'ALTER TABLE billing_members ADD CONSTRAINT FK_2E8E5928296CD8AE FOREIGN KEY (team_id) REFERENCES billing_team (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE'
        );
    }
